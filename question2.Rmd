...
net1 <- graph_from_data_frame(d = edge1, vertices = node_list, directed = TRUE)
...
net2 <- graph_from_data_frame(d = edge2, vertices = node_list, directed = TRUE)
...
net3 <- graph_from_data_frame(d = edge3, vertices = node_list, directed = TRUE)
...
net4 <- graph_from_data_frame(d = edge4, vertices = node_list, directed = TRUE)
...
net5 <- graph_from_data_frame(d = edge5, vertices = node_list, directed = TRUE)
